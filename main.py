...
class MainDialogUI(object):
    ...
    def update_chart(self):
        ...
        if self.chartIndex > 0:
            ...
            if chart_name == "Sampling":
                ...
                self.rule_distance = None
                if self.chartVars[4] is not "" and self.chartVars[5] is not "":
    ...
    def get_prev_image(self):
        ...
        try:
            ...
            self.getImage = pg.QtGui.QGraphicsPixmapItem(self.myImage2)
    ...
    def get_cgats(self):
        ...
        title = "GET CGATS"
        fname = pg.QtGui.QFileDialog.getOpenFileName(qfd, title, path, filter)[0]
        # print( fname)
